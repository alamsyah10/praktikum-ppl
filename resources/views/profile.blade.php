...
<div class="container">
	@if ($already_fill_daily_activities)
		<div class="row justify-content-center">
			<div class="col-md-8">
				<div class = "card" style="background-color: rgba(0,0,0,0.4)">
					<div class = "card-header" style="color: #ffffff"> Info </div>

					<div class="card-body">
						<div class ="form-group row" style="color:#ffffff">
							<div class="col-md-6">
									Kamu Sudah Mengisi Daily Activities Hari Ini
							</div>
						</div>
					</div>
				</div>
	                ...
	                <div class="card-body">
		                <form method="POST" action = "{{ url('profile') }}">
							...
							<fieldset class="form-group" style="color:#ffffff">
							  ...
							  <fieldset class="form-group" style="color:#ffffff">
							    <div class="row">
							      <legend class="col-form-label col-sm-2 pt-10">Dinner Time</legend>
							      <div class="col-sm-10">
							        <div class="form-check">
							          <input class="form-check-input" type="radio" name="dinner_time" id="gridRadios1" value="18:00" checked>
							          <label class="form-check-label" for="gridRadios1">
							            Before 06:00 PM
							          </label>
							        </div>
							        <div class="form-check">
							          <input class="form-check-input" type="radio" name="dinner_time" id="gridRadios2" value="19:00">
							          <label class="form-check-label" for="gridRadios2">
							            Between 08:00 PM - 06:00 PM
							          </label>
							        </div>
							        <div class="form-check">
							          <input class="form-check-input" type="radio" name="dinner_time" id="gridRadios3" value="20:00">
							          <label class="form-check-label" for="gridRadios3">
							            After 08:00 PM
							          </label>
							        </div>
